...
| `CLAUDE_SMART_DASHBOARD_URL` | `http://localhost:3001` | Base URL used in injected citation targets and the final `✨ Applied` marker links. Override only if the local dashboard is exposed on another host or port. |
